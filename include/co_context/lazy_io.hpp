...
inline namespace lazy {
     ...
     * information.
     */
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_splice splice(
        int fd_in,
        int64_t off_in,
        int fd_out,
        int64_t off_out,
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_tee
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_fsync
    fsync(int fd, uint32_t fsync_flags) noexcept {
        return detail::lazy_fsync{fd, fsync_flags};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_uring_nop uring_nop() noexcept {
     ...
     * @return lazy_awaiter
     */
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_timeout_timespec timeout(
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_timeout timeout(
    ...
    template<class Rep, class Period = std::ratio<1>>
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_link_timeout timeout(
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_timeout_remove
    timeout_remove(uint64_t user_data, unsigned flags) noexcept {
        return detail::lazy_timeout_remove{user_data, flags};
    }

    template<class Rep, class Period = std::ratio<1>>
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_timeout_update timeout_update(
        std::chrono::duration<Rep, Period> duration,
        uint64_t user_data,
        unsigned flags = 0
    ) noexcept {
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_accept
    accept(int fd, sockaddr *addr, socklen_t *addrlen, int flags) noexcept {
        return detail::lazy_accept{fd, addr, addrlen, flags};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_accept_direct accept_direct(
        int fd,
        sockaddr *addr,
        socklen_t *addrlen,
        int flags,
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_multishot_accept multishot_accept(
...
#if LIBURINGCXX_IS_KERNEL_REACH(5, 19)
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_multishot_accept_direct
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_rename
    rename(const char *oldpath, const char *newpath) noexcept {
        return detail::lazy_rename{oldpath, newpath};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_sync_file_range
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_symlink
    symlink(const char *target, const char *linkpath) noexcept {
        return detail::lazy_symlink{target, linkpath};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_linkat linkat(
        int olddfd,
        const char *oldpath,
        int newdfd,
        const char *newpath,
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_link
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_msg_ring msg_ring(
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_socket_direct_alloc
    ...
    CO_CONTEXT_AWAIT_HINT inline detail::lazy_yield yield() noexcept {
        return {};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_who_am_i who_am_i() noexcept {
        return {};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_forget forget() noexcept {
        return {};
    }

    CO_CONTEXT_AWAIT_HINT inline detail::lazy_resume_on
